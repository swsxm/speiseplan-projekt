      ...
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-black">
            <li>
            <a href={`${REDIRECT_PAGE}`} className="hover:underline me-4 md:me-6">Über uns</a>
            </li>
            <li>
              <a href={`${REDIRECT_PAGE}`} className="hover:underline me-4 md:me-6">Privacy Policy</a>
            </li>
            <li>
              <a href={`${REDIRECT_PAGE}`}  className="hover:underline me-4 md:me-6">Lizensen</a>
            </li>
            <li>
              <a href={`${REDIRECT_PAGE}`}  className="hover:underline">Kontakt</a>
            </li>
          </ul>
        </div>
